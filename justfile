...
chip8-web:
  ...
  cd crates/retroboy_chip8 && wasm-pack build --target web --features wasm && mv pkg/retroboy_chip8_bg.wasm ../../web/retroboy_bg.wasm && mv pkg/retroboy_chip8.js ../../web/retroboy.js
